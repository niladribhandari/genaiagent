...
import { ServerConfig, ServerContext, ToolResult } from './types/index.js';
import { Workflow, ApprovalRequest } from './types/index.js';
import { requestLogger, errorHandler, corsConfig, asyncHandler } from './middleware/index.js';
import {
  ListGeneratedProjectsHandler,
  ReadFileContentHandler,
  AnalyzeProjectStructureHandler,
  CompileCodeWithAgentHandler,
  ReviewCodeWithAgentHandler,
  GenerateCodeWithAgentHandler,
  GenerateApiSpecWithAgentHandler,
  FixCompilationIssuesWithAgentHandler,
  CreateWorkflowHandler,
  ListWorkflowsHandler,
  GetWorkflowHandler,
  ApproveWorkflowPhaseHandler,
  GetPendingApprovalsHandler
} from './handlers/index.js';
import {
  EnhancedCompileCodeHandler,
  CompilationIssueAnalyzer
} from './handlers/EnhancedCompilationHandlers.js';
...
export class DeveloperAssistantServer {
  ...
  private initializeContext(): ServerContext {
    ...
    if (openaiApiKey) {
      ...
      console.log('[INFO] Available environment variables starting with OPENAI:', 
        Object.keys(process.env).filter(key => key.startsWith('OPENAI')));
    }
