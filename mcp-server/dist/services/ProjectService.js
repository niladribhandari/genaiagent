...
export class ProjectService {
    projectsBasePath;
    constructor(projectsBasePath = '../GeneratedCode') {
    ...
    async listGeneratedProjects() {
        try {
            ...
            const projectsWithDetails = await Promise.all(projects.filter(p => p.isDirectory).map(async (project) => {
     ...
     */
    hasFileInStructure(structure, fileName) {
